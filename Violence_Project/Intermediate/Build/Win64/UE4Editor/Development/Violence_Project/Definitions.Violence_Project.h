...
#define ORIGINAL_FILE_NAME "UE4Editor-Violence_Project.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Violence_Project
...
#define VIOLENCE_PROJECT_API DLLEXPORT
